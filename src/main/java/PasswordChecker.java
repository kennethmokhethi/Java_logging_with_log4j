...
public class PasswordChecker
{
    ...
    public static String passwordIsValid(String password) throws myException {
    ...
    public static String error_handling(boolean password_null  ,boolean pass_length_above_8 ,boolean contain_upper_case_letters ,
                                       boolean contain_lower_case_letter ,boolean contains_special_char ,boolean contain_numbers) throws myException
    {
        try {
            if (!password_null) {
                        ...
                        if (contain_lower_case_letter) {
                            ...
                            if (contain_numbers) {
                                ...
                                if (contains_special_char) {
                                    ...
                                    throw new myException("password should have at least one special character");
                                }
                            } else {
                                throw new myException("password should at least have one digit");
                            }

                        } else {
                            throw new myException("password should have at least one lowercase letter");
                        }

                    } else {
                        throw new myException("password should have at least one uppercase letter");
                    }

                } else {
                    throw new myException("password should be longer than than 8 characters");
                }

            } else {
                throw new myException("password should exist");
            }
        }catch(myException e)
        {
